...
2. **Pattern #18: GitHub Projects: CLI Truncation at 30 Items**
    ...
    > **RETIRED (historical)** — the GitHub Project board is retired for
    > beads (`bd`); Pattern #18 itself is marked RETIRED in
    > `docs/PATTERN-LIBRARY.md`. The `gh project` guidance below is kept as
    > evidence of the review, not as live advice — do not act on it.
